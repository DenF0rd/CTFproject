...
<div class="container">
    <div class="card">
        ...
        <div class="info">
            <i class="fas fa-info-circle"></i> Команда создаётся без привязки к соревнованию.<br>
            Вы сможете присоединить её к любому соревнованию позже.
        </div>
        <% if (request.getAttribute("error") != null) { %>
        <div class="error"><%= request.getAttribute("error") %></div>
        <% } %>
        <form action="${pageContext.request.contextPath}/create-team-global" method="post">
        ...
        <button class="btn btn-secondary" onclick="location.href='${pageContext.request.contextPath}/profile?id=<%= session.getAttribute("userId") %>'">
